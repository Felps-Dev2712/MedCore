...
WSGI_APPLICATION = "medcore_api.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "MedCore System API",
    "DESCRIPTION": "API RESTful do Sistema Integrado de Gestão Hospitalar",
    "VERSION": "1.0.0",
}
